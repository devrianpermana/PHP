		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				<?php if(!$unset_read){?>
					...
					<a href="<?php echo base_url().'/main/download/'.$row->name.'/'.str_replace("/", "-", $row->dob).'/'.$row->s26b2345e?>" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
